      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="h-10 w-10 bg-gradient-to-br from-[#FF6A5C] to-[#02153D] rounded-lg flex items-center justify-center">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Button
              ...
              variant="outline"
              size="sm"
              className="border-[#FF6A5C] text-[#FF6A5C] hover:bg-[#FF6A5C] hover:text-white bg-transparent"
            >
